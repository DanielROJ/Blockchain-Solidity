...
//Busqueda de un Bando de Sangre
...
//Busqueda de la ubicacion de un lote
...
function getTruUnidad(uint idLote,uint idUnidad) public view returns(uint,uint){
return (listaLotesTotales[idLote].listaUnidades[idUnidad].TruInicio, listaLotesTotales[idLote].listaUnidades[idUnidad].TruEnd);
}
